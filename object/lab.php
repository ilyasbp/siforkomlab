<?php  
    ...
    class Lab
    {
        ...
        // Registrasi lab baru
        public function register($nama, $website)
        {
            try
            {
                //Masukkan lab baru ke database
                $query = $this->conn->prepare("INSERT INTO laboratorium(nama_lab, website_lab) VALUES(:nama, :website)");
