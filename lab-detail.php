            ...
            <div class="full-bg-img flex-center">
                <div class="container">
                    <div class="white-text text-center wow fadeInUp">
                        <h1>Laboratorium Pemrograman</h1>
                        <?php
                        ...
                        <h1>Status</h1>
                        <br>
                        <button type="button" class="btn stylish-color-dark">Pengumuman</button>
                        <button type="button" class="btn stylish-color-dark">Jadwal Kegiatan Lab</button>
                        <button type="button" class="btn stylish-color-dark">Saran</button>
                    </div>
                </div>
            </div>
        </div>
